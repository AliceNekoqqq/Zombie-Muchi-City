...
const SETTINGS_HOST='swz-radio-settings-host-v104';
const STYLE='swz-radio-style-v104';
...
function settingsCss(){return `:host{all:initial}.swz-radio-settings-overlay{position:fixed;inset:0;display:none;align-items:center;justify-content:center;padding:12px;overflow:auto;overscroll-behavior:contain;background:rgba(24,31,34,.70);backdrop-filter:blur(10px);font-family:"Noto Sans SC","PingFang SC","Microsoft YaHei",sans-serif;color:#33474c;box-sizing:border-box}.swz-radio-settings-overlay.open{display:flex!important}.swz-radio-settings-overlay *{box-sizing:border-box}.swz-radio-settings-panel{position:relative;width:min(920px,100%);max-height:min(92vh,980px);overflow:auto;border:1px solid rgba(94,121,126,.25);border-radius:22px;background:linear-gradient(180deg,#f6f3ee,#d7d3cb);box-shadow:0 28px 80px rgba(0,0,0,.32)}.swz-settings-close{position:sticky;float:right;top:12px;right:12px;z-index:20;width:38px;height:38px;margin:12px 12px -50px 0;border:1px solid rgba(94,121,126,.22);border-radius:10px;background:linear-gradient(180deg,#fffdf9,#dedad2);color:#51656a;font-size:22px;cursor:pointer}.swz-settings-title{padding:18px 62px 15px 20px;border-bottom:1px solid rgba(94,121,126,.18)}.swz-settings-title b{display:block;font-family:"Noto Serif SC","Songti SC",serif;font-size:18px;letter-spacing:.06em}.swz-settings-title span{display:block;margin-top:5px;color:#697a7e;font-size:9px}.swz-settings-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;padding:12px}.swz-setting-card{padding:14px;border:1px solid rgba(94,121,126,.16);border-radius:14px;background:linear-gradient(180deg,#fffdf8,#e6e1da)}.swz-setting-card.swz-full{grid-column:1/-1}.swz-setting-card h3{margin:0 0 12px;font-family:"Noto Serif SC","Songti SC",serif;font-size:13px;font-weight:600}.swz-setting-card p{margin:8px 0 0;color:#697a7e;font-size:9px;line-height:1.6}.swz-setting-card label{display:block;margin-top:9px;color:#697a7e;font-size:9px}.swz-setting-card input:not([type=checkbox]):not([type=range]),.swz-setting-card select,.swz-setting-card textarea{width:100%;margin-top:5px;padding:9px;border:1px solid rgba(94,121,126,.20);border-radius:9px;background:#fbf8f2;color:#405459;outline:none;font-size:10px}.swz-setting-card textarea{min-height:70px;resize:vertical}.swz-setting-card input[type=range]{width:100%;margin-top:6px}.swz-check{display:flex!important;align-items:center;gap:7px}.swz-check input{margin:0}.swz-engine{display:grid;grid-template-columns:1fr 1fr;gap:7px}.swz-setting-actions{margin-top:10px}.swz-setting-actions button,.swz-setting-footer button{padding:9px 11px;border:1px solid rgba(94,121,126,.20);border-radius:9px;background:linear-gradient(180deg,#fbf8f2,#ddd9d1);color:#405459;font-size:9px;cursor:pointer}.swz-setting-footer{position:sticky;bottom:0;display:flex;justify-content:flex-end;gap:7px;padding:12px 14px;border-top:1px solid rgba(94,121,126,.18);background:rgba(222,218,210,.96)}.swz-setting-footer .primary{background:linear-gradient(180deg,#f7ffff,#d7ece9);color:#2f5b61}@media(max-width:720px){.swz-radio-settings-overlay{padding:0;align-items:stretch}.swz-radio-settings-panel{width:100%;height:100%;max-height:none;border:0;border-radius:0}.swz-settings-grid{grid-template-columns:1fr;padding:9px}.swz-setting-card.swz-full{grid-column:auto}.swz-engine{grid-template-columns:1fr}.swz-settings-title{position:sticky;top:0;z-index:15;background:linear-gradient(180deg,#f6f3ee,#e8e3dc)}.swz-settings-close{position:fixed;top:max(10px,env(safe-area-inset-top));right:max(10px,env(safe-area-inset-right));float:none;margin:0;width:44px;height:44px;z-index:30}}`}
...
export function openSettings(){
  ...
  renderSettings();const host=getSettingsHost();if(host)host.style.setProperty('pointer-events','auto','important');
